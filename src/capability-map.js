...
export const CAPABILITY_MAP_VERSION = '4';
...
export const CAPABILITY_ROWS = [
  ...
  { id: 'menu_type_set', moduleId: 'menus', uiAction: 'Set menu type (food, wine, cocktail, buffet, …)', location: 'app/studio/menus.html · #fType', permission: 'menu_cluster_edit', tool: 'set_menu_cluster_type', promptHint: 'Change this menu to a wine list with wine sections', status: 'missing' },
  { id: 'menu_icon_set', moduleId: 'menus', uiAction: 'Pick menu cluster icon', location: 'app/studio/menus.html · #menuIconGrid', permission: 'menu_cluster_edit', tool: 'set_menu_cluster_icon', promptHint: 'Use the wine glass icon for this menu', status: 'missing' },
  { id: 'menu_export_json', moduleId: 'menus', uiAction: 'Export all menus (JSON backup)', location: 'app/studio/menus.html · #btnExportMenusJson', permission: null, tool: 'export_all_menus_json', promptHint: 'Download a JSON backup of every menu in this workspace', status: 'missing' },
  { id: 'menu_export_all_xls', moduleId: 'menus', uiAction: 'Export all menus (Excel workbook)', location: 'app/studio/menus.html · #btnExportAllMenusXls', permission: null, tool: 'export_all_menus_xlsx', promptHint: 'Export every menu as Excel sheets', status: 'missing' },
  { id: 'menu_guest_publish', moduleId: 'menus', uiAction: 'Publish guest QR menu', location: 'app/studio/menus.html · #btnPublishQr', permission: 'menu_cluster_edit', tool: 'publish_guest_menu', promptHint: 'Publish this menu for guests with a QR link', status: 'missing' },
  { id: 'menu_guest_unpublish', moduleId: 'menus', uiAction: 'Unpublish guest QR menu', location: 'app/studio/menus.html · #btnUnpublishQr', permission: 'menu_cluster_edit', tool: 'unpublish_guest_menu', promptHint: 'Turn off the public guest link for this menu', status: 'missing' },
  { id: 'menu_guest_copy', moduleId: 'menus', uiAction: 'Copy guest menu URL', location: 'app/studio/menus.html · #btnCopyGuestUrl', permission: 'menu_cluster_edit', tool: 'get_guest_menu_url', promptHint: 'Copy the guest-facing menu link', status: 'partial', notes: 'navigator.clipboard' },
  { id: 'menu_guest_qr_card', moduleId: 'menus', uiAction: 'Download QR card (PNG)', location: 'app/studio/menus.html · #btnDownloadQr', permission: 'menu_cluster_edit', tool: 'download_guest_qr_card', promptHint: 'Download a printable QR card with property branding', status: 'partial', notes: 'Client-side via qr-menu.js + esm.sh' },
  { id: 'ws_logo_upload', moduleId: 'menus', uiAction: 'Upload workspace logo (QR / guest page)', location: 'app/studio/menus.html · branding panel', permission: 'workspace_update', tool: 'upload_workspace_logo', promptHint: 'Upload the hotel logo for guest menus and QR cards', status: 'partial', notes: 'workspace-logo.js; Storage or data URL fallback' },
  { id: 'ws_logo_remove', moduleId: 'menus', uiAction: 'Remove workspace logo', location: 'app/studio/menus.html · branding panel', permission: 'workspace_update', tool: 'clear_workspace_logo', promptHint: 'Remove logo from guest QR and public menu', status: 'partial' },
  { id: 'guest_menu_read', moduleId: 'platform', uiAction: 'Read published guest menu by token', location: 'app/m/index.html · get_guest_menu RPC', permission: null, tool: 'get_guest_menu', promptHint: 'Load the public menu for token …', status: 'partial', notes: 'Supabase RPC; no auth' },
  { id: 'guest_menu_lang', moduleId: 'platform', uiAction: 'Guest menu language (?lang= / toggle)', location: 'app/m/index.html', permission: null, tool: 'set_guest_menu_lang', promptHint: 'Show this menu in Turkish for guests', status: 'partial', notes: 'URL param + EN/TR/ES toggle; i18n' },
  { id: 'recipe_menu_sync', moduleId: 'recipes', uiAction: 'Link recipe to menus (sync sections)', location: 'app/studio/recipes.html · menus block', permission: 'recipe_update', tool: 'sync_recipe_menus', promptHint: 'Add this dish to breakfast and remove from bar menu', status: 'partial', notes: 'syncRecipeMenus in menu-structure.js' },
